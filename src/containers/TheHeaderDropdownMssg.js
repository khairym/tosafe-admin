    ...
    >
      ...
      <CDropdownMenu className="pt-0" placement="bottom-end">
        <CDropdownItem
          ...
          color="light"
        >
          <strong>{t("youHave")} {itemsCount} {t("messages")}</strong>
        </CDropdownItem>
        <CDropdownItem href="#">
          <div className="message">
            ...
            <div>
              ...
              <small className="text-muted float-right mt-1">{t("justNow")}</small>
            </div>
            <div className="text-truncate font-weight-bold">
              <span className="fa fa-exclamation text-danger"></span> {t("importantMessage")}
            </div>
        ...
        <CDropdownItem href="#">
          <div className="message">
            ...
            <div>
              ...
              <small className="text-muted float-right mt-1">5 {t("minutesAgo")}</small>
            </div>
        ...
        <CDropdownItem href="#">
          <div className="message">
            ...
            <div>
              ...
              <small className="text-muted float-right mt-1">4:03 {t("am")}</small>
            </div>
            <div className="text-truncate font-weight-bold">Lorem ipsum dolor sit amet</div>
            <div className="small text-muted text-truncate">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt...
            </div>
        ...
        <CDropdownItem href="#" className="text-center border-top">
          <strong>{t("viewAllMessages")}</strong>
        </CDropdownItem>
      </CDropdownMenu>
    </CDropdown>
  )
...
export default withTranslation()(TheHeaderDropdownMssg)